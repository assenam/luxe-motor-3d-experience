...
interface PaymentProofStepProps extends Pick<StepProps, 'selectedFile' | 'onNext' | 'onPrevious' | 'onFileChange'> {}

const PaymentProofStep = ({ selectedFile, onNext, onPrevious, onFileChange }: PaymentProofStepProps) => {
  return (
